...
workspace_name = "machinelearning" # PLACEHOLDER
subscription_id = "a9eb49ae-a27a-401b-943d-50913e9e089d" # PLACEHOLDER
resource_group = "machine-learning-rg" # PLACEHOLDER
experiment_name = "covid_dataset" # PLACEHOLDER
iteration = "38"  # PLACEHOLDER
run_id = "AutoML_fca63876-a1d6-4ffb-816f-f865720bb8d4_38"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':False,'enable_stack_ensembling':False,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'compute_target':'computeVM','enable_dnn':True,'experiment_exit_score':None,'experiment_timeout_minutes':1440,'featurization':'auto','is_timeseries':False,'iteration_timeout_minutes':1440,'max_concurrent_iterations':1,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'covid_dataset','path':'./sample_projects/covid_dataset','primary_metric':'accuracy','region':'eastus','resource_group':'machine-learning-rg','subscription_id':'a9eb49ae-a27a-401b-943d-50913e9e089d','task_type':'classification','validation_size':0.1,'test_size':None,'vm_type':'STANDARD_DS3_V2','workspace_name':'machinelearning','label_column_name':'age','enable_run_restructure':True} # PLACEHOLDER
pipeline_spec = "{\"objects\": [{\"class_name\": \"SparseNormalizer\", \"module\": \"automl.client.core.common.model_wrappers\", \"param_args\": [], \"param_kwargs\": {\"norm\": \"l2\"}, \"prepared_kwargs\": {}, \"spec_class\": \"preproc\"}, {\"class_name\": \"XGBoostClassifier\", \"module\": \"automl.client.core.common.model_wrappers\", \"param_args\": [], \"param_kwargs\": {\"booster\": \"gbtree\", \"colsample_bytree\": 0.5, \"eta\": 0.3, \"gamma\": 0, \"max_depth\": 6, \"max_leaves\": 15, \"n_estimators\": 100, \"objective\": \"reg:logistic\", \"reg_alpha\": 0.4166666666666667, \"reg_lambda\": 0, \"subsample\": 0.5, \"tree_method\": \"auto\"}, \"prepared_kwargs\": {}, \"spec_class\": \"sklearn\"}], \"pipeline_id\": \"5b463a93c23c8104273c0de7067da891a09cfcfa\", \"module\": \"sklearn.pipeline\", \"class_name\": \"Pipeline\", \"pipeline_name\": \"{ SparseNormalizer, XGBoostClassifier }\"}" # PLACEHOLDER
pipeline_id = "5b463a93c23c8104273c0de7067da891a09cfcfa" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"7dbb8dd8-20c0-4fdc-8cfc-08ba63c15ada\"}}" # PLACEHOLDER
